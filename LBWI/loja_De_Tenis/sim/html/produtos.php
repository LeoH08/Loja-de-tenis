...
<head>
    ...
    <link rel="stylesheet" href="../css/hf.css ?echo get_that_filetime('./style.css'); ?>" />
...
<body style="background-color: #23272f;">
    ...
    <main>
        <section id="products">
            ...
            <div class="product-container"><script type="module" src="../html/app.js"></script></div> <!-- Ensure this container exists -->
        </section>
    </main>
