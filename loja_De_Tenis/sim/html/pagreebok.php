...
<head>
    ...
    <title>Reebok - Loja de Tênis</title>
    ...
    <link rel="stylesheet" href="../css/pagreebok.css?php echo get_cache_buster('../css/categnike.css'); ?>" />
...
<body>
    ...
    <main>
        <section id="reebok-products">
            <h2>Reebok - Produtos</h2>
